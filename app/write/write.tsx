    ...
    >
      ...
      {currentStep === 2 && (
        <View style={styles.viewContainer}>
          ...
          <QuestionBox
            ...
            isDisabled={selectedMatchResult ? false : true}
          />
        </View>
      )}
      {currentStep === 3 && (
        <View style={styles.viewContainer}>
          ...
          <TouchableOpacity onPress={() => onPlaceClick("base")}>
            <View
              style={
                selectedPlace === "base"
                  ? styles.selectButton
                  : styles.defaultSelectButton
              }
            >
              <Image
      ...
      <View style={styles.buttonBox}>
        <TouchableOpacity
          activeOpacity={1}
          style={
            nextButtonEnabled ? styles.nextButton : styles.nextDisabledButton
          }
        ...
        >
          <Text
            style={
              nextButtonEnabled ? styles.buttonText : styles.buttonDisabledText
            }
          >
