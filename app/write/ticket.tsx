    ...
    <SafeAreaView style={styles.container}>
              ...
              <TextInput
                ...
                value={
                  [
                    ...
                    ? (writeData[
                        item.value as keyof IWriteDataInterface
                      ] as string)
                    : ""
                }
                onFocus={() => {
      ...
      <View style={styles.footerButtonBox}>
        <TouchableOpacity
          ...
          onPress={() => router.navigate("/write/todayTicketCard")}
        >
            ...
            <View style={styles.optionsContainer}>
              {teamOptions.map((option) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.optionButton,
                    writeData.matchTeam === option.label &&
              ...
              {placeOption.map((option) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    writeData.matchPlace === option.label &&
                      styles.selectedOption,
                  ]}
                  activeOpacity={1}
          ...
          <View style={styles.writePlaceModalContent}>
            ...
            <View style={styles.writePlaceOptionsContainer}>
              {tabMenuConfig.map((option) => (
                <TouchableOpacity
                  key={option.value}
                  style={[
                    styles.writePlaceOptionButton,
                    selectedTabMenu === option.title && styles.selectedOption,
                  ]}
                  activeOpacity={1}
                ...
                >
                  <Text
                    style={[
                      styles.optionText,
                      selectedTabMenu === option.title &&
                        styles.selectedWriteOptionText,
                    ]}
                  >
                    {option.title}
                  </Text>
            ...
            <View style={styles.writeButtonBox}>
              <TouchableOpacity
                ...
                onPress={() => setTabMenuModalVisible(false)}
              >
                <Text style={styles.cancelText}>취소</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.confirmButton}
                onPress={handleConfirmTabMenu}
              >
